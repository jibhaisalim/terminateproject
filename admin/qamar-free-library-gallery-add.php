    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="qamar-free-library-gallery-table.php">Gallery Tables</a></li>
          <li class="breadcrumb-item"><a href="qamar-free-library-gallery-add.php">Gallery Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <?php 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="q-gallery-save.php" method="POST" enctype="multipart/form-data">
