    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="patni-education-trust-about.php">About Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <?php 
...
?>
              ...
              <form action="e-update.php" method="POST" enctype="multipart/form-data">
