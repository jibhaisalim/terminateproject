...
// if($_POST['old_category'] != $_POST["designation"]){
//   $sql .= "UPDATE category SET post= post - 1 WHERE d_id = {$_POST['old_category']};";
//   $sql .= "UPDATE category SET post= post + 1 WHERE d_id = {$_POST["designation"]};";
// }
