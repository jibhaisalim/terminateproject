    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-education-trust-gallery-table.php">Gallery Tables</a></li>
          <li class="breadcrumb-item"><a href="patni-education-trust-gallery-add.php">Gallery Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <?php 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="e-gallery-save.php" method="POST" enctype="multipart/form-data">
