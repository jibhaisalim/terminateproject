...
<?php include 'header.php';?>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-education-trust-upcoming-event-table.php">Add Events Form</a></li>
          <li class="breadcrumb-item active"><a href="patni-education-trust-upcoming-event-add.php">Events Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <!-- General Form Elements -->
                <form  action="e-event-save.php" method="POST" enctype="multipart/form-data">

                    <div class="row mb-3">
                      <label for="input-hidden" class="col-sm-2 col-form-label"></label>
                       <div class="col-sm-8">
                         <input type="hidden" name="committee_id[]" class="form-control" value="3" placeholder=""> 
                       </div> 
                    </div>
