    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-co-operative-credit-society-ltd-committee-members-gallery-table.php">Events</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
?>
              ...
              <form  action="e-event-updata.php" method="POST" enctype="multipart/form-data">
