    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-education-trust-gallery-update.php">Gallery Tables</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
?>
              ...
              <form action="e-gallery-updata.php" method="POST" enctype="multipart/form-data">
