    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-co-operative-credit-society-ltd-committee-members-table.php">Committee Members Tables</a></li>
          <li class="breadcrumb-item active"><a href="patni-co-operative-credit-society-ltd-committee-members-add.php">Members Add Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Committee Members Add Form</h5>


              <form action="co-member-save.php" method="POST" enctype="multipart/form-data">
                        
                    

                             <input type="hidden" name="committee_id[]" value="2" class="form-control">
