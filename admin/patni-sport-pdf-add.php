    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-sport-report-table.php">Report Tables</a></li>
          <li class="breadcrumb-item active"><a href="patni-sport-pdf-add.php">Add Report</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->  
      ...
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            ...
            <form action="spo_report_insert.php" method="POST" enctype="multipart/form-data">

             <input type="hidden" name="committee_id[]" value="6" class="form-control">
