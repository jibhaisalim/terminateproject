    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-co-operative-credit-society-ltd-committee-members-gallery-add.php">Gallery Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <?php 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="co-gallery-save.php" method="POST" enctype="multipart/form-data">
