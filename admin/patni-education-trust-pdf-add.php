<?php include 'header.php';?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Committee Report table</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="patni-education-trust-report-table.php">Report Tables</a></li>
          <li class="breadcrumb-item active"><a href="patni-education-trust-pdf-add.php">Add Report</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->  
      ...
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            ...
            <form action="edu_report_insert.php" method="POST" enctype="multipart/form-data">
