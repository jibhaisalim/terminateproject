    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-sports-committee-members-table.php">Committee Members Tables</a></li>
          <li class="breadcrumb-item active"><a href="patni-sports-committee-members-add.php">Members Add Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            ...
            <form action="s-member-save.php" method="POST" enctype="multipart/form-data">
