...
<?php include 'header.php';?>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="qamar-free-library-upcoming-event-table.php">Add Events Tables</a></li>
          <li class="breadcrumb-item active"><a href="qamar-free-library-upcoming-event-add.php">Add Events Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <!-- General Form Elements -->
                <form  action="q-event-save.php" method="POST" enctype="multipart/form-data">

                    <div class="row mb-3">
                      <label for="input-hidden" class="col-sm-2 col-form-label"></label>
                       <div class="col-sm-8">
                         <input type="hidden" name="committee_id[]" class="form-control" value="5" placeholder=""> 
                       </div> 
                    </div>
