...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="patni-housing-society-contact.php">Contact Form</a></li>
    </ol>
  </nav>
</div><!-- End Page Title -->
<?php 
...
$sql= "SELECT * FROM contact WHERE sid=4";
...
?>
          <!-- Vertical Form -->
          <form class="row g-3" action="h-contact-update.php" method="POST">
          ...
          <div class="col-12">
           ...
           <div class="col-12">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="inputNanme4" name="phone_number" value="<?php echo $row['phone_number'];?>">
            </div>
            <div class="col-12">
