...
<head>
  ...
  <title>Death Registration Update Form</title>
  ...
  <div class="pagetitle">
      <nav>
        ...
        <img src="assets/img/logo.png" alt="">
          <span class="d-none d-lg-block">Death Registration Update Form</span>
        </a>
      </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Death Registration Update Form</h5>
...
require ('config1.php');
 ...
 $sql = "SELECT * FROM deathregi WHERE de_id={$birt_id}";
...
?>
 ...
 <form class="row g-3" action="death_update.php" method="POST" >

 <input type="hidden" name="de_id" class="form-control" value="<?php echo $row['de_id'];?>"> 


 <div class="col-md-6">
    <label for="inputText" class="form-label">Deceased's Name (મરનાર નું નામ)</label>
    <input type="text" name="dname" class="form-control" id="inputstudent"  value="<?php echo $row['dname'];?>" required>
  </div>
...
<div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="age" class="form-control" id="inputname" value="<?php echo $row['age'];?>" required>
  </div>
 ...
 <div class="col-12">
    ...
    <input type="text" name="daddress" class="form-control" id="inputAddress"  value="<?php echo $row['daddress'];?>" required>
  </div>

  <div class="col-12">
    <label for="inputAddress2" class="form-label">Death Date (મરણ તારીખ)</label>
    <input type="date" name="ddate" class="form-control" id="inputAddress2" value="<?php echo $row['ddate'];?>" required>
  </div>

  <div class="col-12">
    <label for="inputAddress2" class="form-label">Place of Burial (દફન કર્યા ની જગ્યા- કબ્રસ્તાન)</label>
    <input type="text" name="bplace" class="form-control" id="inputAddress2" value="<?php echo $row['bplace'];?>" required>
  </div>
  ...
  <div class="col-12">
    ...
    <a href="death_print.php?id=<?php echo $row['de_id'];?>" target="_blank" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
  </div>
</form>
        <?php }
          }?>        
