...
<?php include 'header.php';?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Events Add Form</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="patni-co-operative-credit-society-ltd-upcoming-event-table.php">Events Add Form</a></li>
          <li class="breadcrumb-item active"><a href="patni-co-operative-credit-society-ltd-upcoming-event-add.php">Events Add Form</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <!-- General Form Elements -->
                <form  action="co-event-save.php" method="POST" enctype="multipart/form-data">

                    <div class="row mb-3">
                      <label for="input-hidden" class="col-sm-2 col-form-label"></label>
                       <div class="col-sm-8">
                         <input type="hidden" name="committee_id[]" class="form-control" value="2" placeholder=""> 
                       </div> 
                    </div>
