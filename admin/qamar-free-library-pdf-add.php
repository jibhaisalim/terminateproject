    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="qamar-free-library-report-table.php">Report Tables</a></li>
          <li class="breadcrumb-item active"><a href="qamar-free-library-pdf-add.php">Add Report</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->  
      ...
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            ...
            <form action="qam_report_insert.php" method="POST" enctype="multipart/form-data">
