    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="patni-sunnat-jamaat-pdf-table.php">Report Tables</a></li>
          <li class="breadcrumb-item active"><a href="patni-sunnat-jamaat-pdf-add.php">Add Report</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->  
      ...
      <div class="row">
        ...
        <?php 
          ...
          <div class="card">
            ...
            <form action="report_insert.php" method="POST" enctype="multipart/form-data">
