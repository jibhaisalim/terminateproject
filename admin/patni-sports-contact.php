...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="patni-sports-contact.php">Contact Form</a></li>
    </ol>
  </nav>
</div><!-- End Page Title -->
<?php 
...
$sql= "SELECT * FROM contact WHERE sid=6";
...
?>
          <!-- Vertical Form -->
          <form class="row g-3" action="s-contact-update.php" method="POST">
