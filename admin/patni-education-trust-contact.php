...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="patni-education-trust-contact.php">Contact Form</a></li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
$sql= "SELECT * FROM contact WHERE sid=3";
...
?>
          <!-- Vertical Form -->
          <form class="row g-3" action="e-contact-update.php" method="POST">
