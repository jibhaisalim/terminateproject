...
?>
                         ...
                         <!-- General Form Elements -->
                           <form action="co-member-update.php" method="POST" enctype="multipart/form-data">
                           <div class="row mb-3">
           ...
           <select class="form-control" name="designation" aria-label="Default select example" required>
                ...
                <input type="hidden" name="old_category" value="<?php echo $row['designation']; ?>">
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                <button type="submit" value="update" name="update" class="btn btn-primary">Save Now</button>
                              </div>
                            </div>
