    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="patni-sports-committee-members-table.php">Committee Members</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <?php 
              ...
              <div class="position-absolute top-0 end-0" style="margin-top:15px;margin-right:15px;">
               <label>
                ...
                <button type="button" class="btn btn-primary">
                  <a href="patni-sports-committee-members-add.php" class="link-light">Add Members</a>
                </button>
                </div>
                ...
                <?php
                 ...
                 ?>
                  <tr>
                    ...
                    <td><a href="patni-sports-committee-members-delete.php?id=<?php echo $row['member_id'];?>" style="height:50px;width:50px;"><i class="bi bi-trash"></a></i></td>
                    <td><a href="patni-sports-committee-members-update.php?id=<?php echo $row['member_id'];?>"><i class="bi bi-pen"></a></i></td>
                  </tr>
                  <?php }?>
                </tbody>
              </table>
