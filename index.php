...
$select = "SELECT * FROM contact WHERE sid='1'";
...
<head>
  ...
  <title>Patni Sunnat Jamaat - Surat</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2 style="font-family: 'DM Serif Display', serif;"><span style="color:blue";>The Patni Jamaat-Surat</span></h2>
      <div>
...
//Select query 
$select = "SELECT * FROM even WHERE committee_id='1'";
...
$sql = "SELECT * FROM `report` WHERE committee_id='1'";
...
$sql = "SELECT gid,filename FROM gallery WHERE committee_id='1'";
...
<section id="heros">
 <div class="heros-content" data-aos="fade-up">
        <div class="section">
          ...
          <a href="birthreg.php" class="btn-get-started scrollto">Birth Registration</a>
          <a href="deathreg.php" class="btn-projects scrollto">Death Registration</a>
        </div>
      </div>
...
<!-- End Hero Section -->
 ...
 <script>
  ...
  $.post('submit.php', { dropdownValue: temp }, function(data){
                    document.getElementById('data').innerHTML = data;
                    console.log(data)
                    //do after submission operation in DOM
                });
