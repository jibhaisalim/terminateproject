...
$select = "SELECT * FROM contact WHERE sid='6'";
...
<head>
  ...
  <title>Patni Sports - Surat</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2 style="font-family: 'DM Serif Display', serif;"><span style="color:blue";>The Patni Sports- Surat</span></h2>
      <div>
        <a href="#about5" class="btn-get-started scrollto">Book Hall</a>
        <a href="#portfolio5" class="btn-projects scrollto">Our Projects</a>
      </div>
    </div> 
...
//Select query 
$select = "SELECT * FROM even WHERE committee_id='6'";
...
$sql = "SELECT * FROM `report` WHERE committee_id='6'";
...
?>
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio5" class="portfolio">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
...
$sql = "SELECT gid,filename FROM gallery WHERE committee_id='6'";
...
$('#yearSelect').change(function(){
    ...
    $.post('submit5.php', { dropdownValue: inputValue }, function(data){
...
$.post('submit5.php', { dropdownValue: temp }, function(data){
        document.getElementById('data').innerHTML = data;
        console.log(data)
        //do after submission operation in DOM
    });
