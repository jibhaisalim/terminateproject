...
$select = "SELECT * FROM contact WHERE sid='4'";
...
<head>
  ...
  <title>Patni Housing Society - Surat</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2 style="font-family: 'DM Serif Display', serif;"><span style="color:blue";>The Patni Housing Society - Surat</span></h2>
      <div>
        <a href="#about3" class="btn-get-started scrollto">Book Hall</a>
        <a href="#portfolio3" class="btn-projects scrollto">Our Projects</a>
      </div>
    </div> 
...
$sql = "SELECT * FROM about WHERE sid='4'";
...
//Select query 
$select = "SELECT * FROM even WHERE committee_id='4'";
...
$sql = "SELECT * FROM `report` WHERE committee_id='4'";
...
?>
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio3" class="portfolio3">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
...
$sql = "SELECT gid,filename FROM gallery WHERE committee_id='4'";
...
$(document).ready(function(){
            $('#yearSelect').change(function(){
                ...
                $.post('submit3.php', { dropdownValue: inputValue }, function(data){
  ...
  $.post('submit3.php', { dropdownValue: temp }, function(data){
                    document.getElementById('data').innerHTML = data;
                    console.log(data)
                    //do after submission operation in DOM
                });
