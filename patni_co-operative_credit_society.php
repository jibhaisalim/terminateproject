...
$select = "SELECT * FROM contact WHERE sid='2'";
...
<head>
  ...
  <title>Patni Co-operative Credit Society</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2 style="font-family: 'DM Serif Display', serif;"><span style="color:blue";>Patni Co-operative Credit Society</span></h2>
      <div>
...
$sql = "SELECT * FROM about WHERE sid='2'";
...
//Select query 
$select = "SELECT * FROM even WHERE committee_id='2'";
...
$sql = "SELECT * FROM `report` WHERE committee_id='2'";
...
$sql = "SELECT gid,filename FROM gallery WHERE committee_id='2'";
...
$(document).ready(function(){
            $('#yearSelect').change(function(){
                ...
                $.post('submit1.php', { dropdownValue: inputValue }, function(data){
  ...
  $.post('submit1.php', { dropdownValue: temp }, function(data){
                    document.getElementById('data').innerHTML = data;
                    console.log(data)
                    //do after submission operation in DOM
                });
