...
$select = "SELECT * FROM contact WHERE sid='5'";
...
<head>
  ...
  <title>Qamar Free Library - Surat</title>
...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2 style="font-family: 'DM Serif Display', serif;"><span style="color:blue";>The Qamar Free Library - Surat</span></h2>
      <div>
        <a href="#about" class="btn-get-started scrollto">Book Hall</a>
...
$sql = "SELECT * FROM about WHERE sid='5'";
...
?>
  ...
  <?php }}?>
    ...
    <!-- <section id="services4">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2 class="typing-demo">Committees</h2>
          <p>It has different committees to run different services such as:</p>
        </div>
...
//Select query 
$select = "SELECT * FROM even WHERE committee_id='5'";
...
$sql = "SELECT * FROM `report` WHERE committee_id='5'";
...
?>
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio4" class="portfolio">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
...
$sql = "SELECT gid,filename FROM gallery WHERE committee_id='5'";
...
#heros .heros-slider .swiper-slide {
 ...
 <div class="heros-content" data-aos="fade-up">
        <div class="section">
          ...
          <a href="qamar_membership.php" class="btn-get-started scrollto">Qamar Membership Application</a>
        </div>
      </div>
 </section>
  </main><!-- End #main -->
 ...
 <script>
  $(document).ready(function(){
            $('#yearSelect').change(function(){
                ...
                $.post('submit4.php', { dropdownValue: inputValue }, function(data){
  ...
  $.post('submit4.php', { dropdownValue: temp }, function(data){
                    document.getElementById('data').innerHTML = data;
                    console.log(data)
                    //do after submission operation in DOM
                });
