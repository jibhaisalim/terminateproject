    ...
    <div class="pagetitle">
      <nav>
        ...
        <img src="assets/img/logo.png" alt="">
          <span class="d-none d-lg-block">Birth Registration Form</span>
        </a>
      </nav>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Birth Registration Form</h5>

 <form class="row g-3" action="birth_save.php" method="POST">
...
<div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="mname" class="form-control" id="inputname" required>
  </div>
 ...
 <div class="col-12">
    ...
    <input type="text" name="baddress" class="form-control" id="inputAddress"  required>
  </div>

  <div class="col-12">
    <label for="inputAddress2" class="form-label">Birth Date (જન્મ તારીખ)</label>
    <input type="date" name="bdate" class="form-control" id="inputAddress2" required>
  </div>
